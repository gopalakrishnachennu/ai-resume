 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nu="FirebaseError";class Me extends Error{constructor(t,e,n){super(e),this.code=t,this.customData=n,this.name=Nu,Object.setPrototypeOf(this,Me.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,ma.prototype.create)}}class ma{constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}create(t,...e){const n=e[0]||{},i=`${this.service}/${t}`,o=this.errors[t],c=o?xu(o,n):"Error",l=`${this.serviceName}: ${c} (${i}).`;return new Me(i,l,n)}}function xu(r,t){return r.replace(ku,(e,n)=>{const i=t[n];return i!=null?String(i):`<${n}?>`})}const ku=/\{\$([^}]+)}/g;function Yn(r,t){if(r===t)return!0;const e=Object.keys(r),n=Object.keys(t);for(const i of e){if(!n.includes(i))return!1;const o=r[i],c=t[i];if(so(o)&&so(c)){if(!Yn(o,c))return!1}else if(o!==c)return!1}for(const i of n)if(!e.includes(i))return!1;return!0}function so(r){return r!==null&&typeof r=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const os="[DEFAULT]",Vl={[is]:"fire-core",[rl]:"fire-core-compat",[il]:"fire-analytics",[sl]:"fire-analytics-compat",[al]:"fire-app-check",[ol]:"fire-app-check-compat",[cl]:"fire-auth",[ul]:"fire-auth-compat",[ll]:"fire-rtdb",[hl]:"fire-data-connect",[dl]:"fire-rtdb-compat",[fl]:"fire-fn",[gl]:"fire-fn-compat",[ml]:"fire-iid",[pl]:"fire-iid-compat",[_l]:"fire-fcm",[yl]:"fire-fcm-compat",[El]:"fire-perf",[Tl]:"fire-perf-compat",[vl]:"fire-rc",[Il]:"fire-rc-compat",[wl]:"fire-gcs",[Al]:"fire-gcs-compat",[Rl]:"fire-fst",[Sl]:"fire-fst-compat",[Cl]:"fire-vertex","fire-js":"fire-js",[Pl]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ml=bl;function Ea(r,t={}){let e=r;typeof t!="object"&&(t={name:t});const n={name:os,automaticDataCollectionEnabled:!0,...t},i=n.name;if(typeof i!="string"||!i)throw Qt.create("bad-app-name",{appName:String(i)});if(e||(e=ga()),!e)throw Qt.create("no-options");const o=gn.get(i);if(o){if(Yn(e,o.options)&&Yn(n,o.config))return o;throw Qt.create("duplicate-app",{appName:i})}const c=new Uu(i);for(const d of as.values())c.addComponent(d);const l=new Ol(e,n,c);return gn.set(i,l),l}function Ll(r=os){const t=gn.get(r);if(!t&&r===os&&ga())return Ea();if(!t)throw Qt.create("no-app",{appName:r});return t}function lo(){return Array.from(gn.values())}function Ce(r,t,e){let n=Vl[r]??r;e&&(n+=`-${e}`);const i=n.match(/\s|\//),o=t.match(/\s|\//);if(i||o){const c=[`Unable to register library "${n}" with version "${t}":`];i&&c.push(`library name "${n}" contains illegal characters (whitespace or "/")`),i&&o&&c.push("and"),o&&c.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Lt.warn(c.join(" "));return}Jn(new fn(`${n}-version`,()=>({library:n,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fl="firebase-heartbeat-database",Ul=1,mn="firebase-heartbeat-store";let zr=null;function Ta(){return zr||(zr=Ju(Fl,Ul,{upgrade:(r,t)=>{switch(t){case 0:try{r.createObjectStore(mn)}catch(e){console.warn(e)}}}}).catch(r=>{throw Qt.create("idb-open",{originalErrorMessage:r.message})})),zr}async function Bl(r){try{const e=(await Ta()).transaction(mn),n=await e.objectStore(mn).get(va(r));return await e.done,n}catch(t){if(t instanceof Me)Lt.warn(t.message);else{const e=Qt.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});Lt.warn(e.message)}}}async function ho(r,t){try{const n=(await Ta()).transaction(mn,"readwrite");await n.objectStore(mn).put(t,va(r)),await n.done}catch(e){if(e instanceof Me)Lt.warn(e.message);else{const n=Qt.create("idb-set",{originalErrorMessage:e==null?void 0:e.message});Lt.warn(n.message)}}}function va(r){return`${r.name}!${r.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ce(Ql,Wl,"app");var mo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var Wt,Ia;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function t(E,g){function p(){}p.prototype=g.prototype,E.F=g.prototype,E.prototype=new p,E.prototype.constructor=E,E.D=function(T,y,v){for(var m=Array(arguments.length-2),rt=2;rt<arguments.length;rt++)m[rt-2]=arguments[rt];return g.prototype[y].apply(T,m)}}function e(){this.blockSize=-1}function n(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}t(n,e),n.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(E,g,p){p||(p=0);const T=Array(16);if(typeof g=="string")for(var y=0;y<16;++y)T[y]=g.charCodeAt(p++)|g.charCodeAt(p++)<<8|g.charCodeAt(p++)<<16|g.charCodeAt(p++)<<24;else for(y=0;y<16;++y)T[y]=g[p++]|g[p++]<<8|g[p++]<<16|g[p++]<<24;g=E.g[0],p=E.g[1],y=E.g[2];let v=E.g[3],m;m=g+(v^p&(y^v))+T[0]+3614090360&4294967295,g=p+(m<<7&4294967295|m>>>25),m=v+(y^g&(p^y))+T[1]+3905402710&4294967295,v=g+(m<<12&4294967295|m>>>20),m=y+(p^v&(g^p))+T[2]+606105819&4294967295,y=v+(m<<17&4294967295|m>>>15),m=p+(g^y&(v^g))+T[3]+3250441966&4294967295,p=y+(m<<22&4294967295|m>>>10),m=g+(v^p&(y^v))+T[4]+4118548399&4294967295,g=p+(m<<7&4294967295|m>>>25),m=v+(y^g&(p^y))+T[5]+1200080426&4294967295,v=g+(m<<12&4294967295|m>>>20),m=y+(p^v&(g^p))+T[6]+2821735955&4294967295,y=v+(m<<17&4294967295|m>>>15),m=p+(g^y&(v^g))+T[7]+4249261313&4294967295,p=y+(m<<22&4294967295|m>>>10),m=g+(v^p&(y^v))+T[8]+1770035416&4294967295,g=p+(m<<7&4294967295|m>>>25),m=v+(y^g&(p^y))+T[9]+2336552879&4294967295,v=g+(m<<12&4294967295|m>>>20),m=y+(p^v&(g^p))+T[10]+4294925233&4294967295,y=v+(m<<17&4294967295|m>>>15),m=p+(g^y&(v^g))+T[11]+2304563134&4294967295,p=y+(m<<22&4294967295|m>>>10),m=g+(v^p&(y^v))+T[12]+1804603682&4294967295,g=p+(m<<7&4294967295|m>>>25),m=v+(y^g&(p^y))+T[13]+4254626195&4294967295,v=g+(m<<12&4294967295|m>>>20),m=y+(p^v&(g^p))+T[14]+2792965006&4294967295,y=v+(m<<17&4294967295|m>>>15),m=p+(g^y&(v^g))+T[15]+1236535329&4294967295,p=y+(m<<22&4294967295|m>>>10),m=g+(y^v&(p^y))+T[1]+4129170786&4294967295,g=p+(m<<5&4294967295|m>>>27),m=v+(p^y&(g^p))+T[6]+3225465664&4294967295,v=g+(m<<9&4294967295|m>>>23),m=y+(g^p&(v^g))+T[11]+643717713&4294967295,y=v+(m<<14&4294967295|m>>>18),m=p+(v^g&(y^v))+T[0]+3921069994&4294967295,p=y+(m<<20&4294967295|m>>>12),m=g+(y^v&(p^y))+T[5]+3593408605&4294967295,g=p+(m<<5&4294967295|m>>>27),m=v+(p^y&(g^p))+T[10]+38016083&4294967295,v=g+(m<<9&4294967295|m>>>23),m=y+(g^p&(v^g))+T[15]+3634488961&4294967295,y=v+(m<<14&4294967295|m>>>18),m=p+(v^g&(y^v))+T[4]+3889429448&4294967295,p=y+(m<<20&4294967295|m>>>12),m=g+(y^v&(p^y))+T[9]+568446438&4294967295,g=p+(m<<5&4294967295|m>>>27),m=v+(p^y&(g^p))+T[14]+3275163606&4294967295,v=g+(m<<9&4294967295|m>>>23),m=y+(g^p&(v^g))+T[3]+4107603335&4294967295,y=v+(m<<14&4294967295|m>>>18),m=p+(v^g&(y^v))+T[8]+1163531501&4294967295,p=y+(m<<20&4294967295|m>>>12),m=g+(y^v&(p^y))+T[13]+2850285829&4294967295,g=p+(m<<5&4294967295|m>>>27),m=v+(p^y&(g^p))+T[2]+4243563512&4294967295,v=g+(m<<9&4294967295|m>>>23),m=y+(g^p&(v^g))+T[7]+1735328473&4294967295,y=v+(m<<14&4294967295|m>>>18),m=p+(v^g&(y^v))+T[12]+2368359562&4294967295,p=y+(m<<20&4294967295|m>>>12),m=g+(p^y^v)+T[5]+4294588738&4294967295,g=p+(m<<4&4294967295|m>>>28),m=v+(g^p^y)+T[8]+2272392833&4294967295,v=g+(m<<11&4294967295|m>>>21),m=y+(v^g^p)+T[11]+1839030562&4294967295,y=v+(m<<16&4294967295|m>>>16),m=p+(y^v^g)+T[14]+4259657740&4294967295,p=y+(m<<23&4294967295|m>>>9),m=g+(p^y^v)+T[1]+2763975236&4294967295,g=p+(m<<4&4294967295|m>>>28),m=v+(g^p^y)+T[4]+1272893353&4294967295,v=g+(m<<11&4294967295|m>>>21),m=y+(v^g^p)+T[7]+4139469664&4294967295,y=v+(m<<16&4294967295|m>>>16),m=p+(y^v^g)+T[10]+3200236656&4294967295,p=y+(m<<23&4294967295|m>>>9),m=g+(p^y^v)+T[13]+681279174&4294967295,g=p+(m<<4&4294967295|m>>>28),m=v+(g^p^y)+T[0]+3936430074&4294967295,v=g+(m<<11&4294967295|m>>>21),m=y+(v^g^p)+T[3]+3572445317&4294967295,y=v+(m<<16&4294967295|m>>>16),m=p+(y^v^g)+T[6]+76029189&4294967295,p=y+(m<<23&4294967295|m>>>9),m=g+(p^y^v)+T[9]+3654602809&4294967295,g=p+(m<<4&4294967295|m>>>28),m=v+(g^p^y)+T[12]+3873151461&4294967295,v=g+(m<<11&4294967295|m>>>21),m=y+(v^g^p)+T[15]+530742520&4294967295,y=v+(m<<16&4294967295|m>>>16),m=p+(y^v^g)+T[2]+3299628645&4294967295,p=y+(m<<23&4294967295|m>>>9),m=g+(y^(p|~v))+T[0]+4096336452&4294967295,g=p+(m<<6&4294967295|m>>>26),m=v+(p^(g|~y))+T[7]+1126891415&4294967295,v=g+(m<<10&4294967295|m>>>22),m=y+(g^(v|~p))+T[14]+2878612391&4294967295,y=v+(m<<15&4294967295|m>>>17),m=p+(v^(y|~g))+T[5]+4237533241&4294967295,p=y+(m<<21&4294967295|m>>>11),m=g+(y^(p|~v))+T[12]+1700485571&4294967295,g=p+(m<<6&4294967295|m>>>26),m=v+(p^(g|~y))+T[3]+2399980690&4294967295,v=g+(m<<10&4294967295|m>>>22),m=y+(g^(v|~p))+T[10]+4293915773&4294967295,y=v+(m<<15&4294967295|m>>>17),m=p+(v^(y|~g))+T[1]+2240044497&4294967295,p=y+(m<<21&4294967295|m>>>11),m=g+(y^(p|~v))+T[8]+1873313359&4294967295,g=p+(m<<6&4294967295|m>>>26),m=v+(p^(g|~y))+T[15]+4264355552&4294967295,v=g+(m<<10&4294967295|m>>>22),m=y+(g^(v|~p))+T[6]+2734768916&4294967295,y=v+(m<<15&4294967295|m>>>17),m=p+(v^(y|~g))+T[13]+1309151649&4294967295,p=y+(m<<21&4294967295|m>>>11),m=g+(y^(p|~v))+T[4]+4149444226&4294967295,g=p+(m<<6&4294967295|m>>>26),m=v+(p^(g|~y))+T[11]+3174756917&4294967295,v=g+(m<<10&4294967295|m>>>22),m=y+(g^(v|~p))+T[2]+718787259&4294967295,y=v+(m<<15&4294967295|m>>>17),m=p+(v^(y|~g))+T[9]+3951481745&4294967295,E.g[0]=E.g[0]+g&4294967295,E.g[1]=E.g[1]+(y+(m<<21&4294967295|m>>>11))&4294967295,E.g[2]=E.g[2]+y&4294967295,E.g[3]=E.g[3]+v&4294967295}n.prototype.v=function(E,g){g===void 0&&(g=E.length);const p=g-this.blockSize,T=this.C;let y=this.h,v=0;for(;v<g;){if(y==0)for(;v<=p;)i(this,E,v),v+=this.blockSize;if(typeof E=="string"){for(;v<g;)if(T[y++]=E.charCodeAt(v++),y==this.blockSize){i(this,T),y=0;break}}else for(;v<g;)if(T[y++]=E[v++],y==this.blockSize){i(this,T),y=0;break}}this.h=y,this.o+=g},n.prototype.A=function(){var E=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);E[0]=128;for(var g=1;g<E.length-8;++g)E[g]=0;g=this.o*8;for(var p=E.length-8;p<E.length;++p)E[p]=g&255,g/=256;for(this.v(E),E=Array(16),g=0,p=0;p<4;++p)for(let T=0;T<32;T+=8)E[g++]=this.g[p]>>>T&255;return E};function o(E,g){var p=l;return Object.prototype.hasOwnProperty.call(p,E)?p[E]:p[E]=g(E)}function c(E,g){this.h=g;const p=[];let T=!0;for(let y=E.length-1;y>=0;y--){const v=E[y]|0;T&&v==g||(p[y]=v,T=!1)}this.g=p}var l={};function d(E){return-128<=E&&E<128?o(E,function(g){return new c([g|0],g<0?-1:0)}):new c([E|0],E<0?-1:0)}function f(E){if(isNaN(E)||!isFinite(E))return I;if(E<0)return N(f(-E));const g=[];let p=1;for(let T=0;E>=p;T++)g[T]=E/p|0,p*=4294967296;return new c(g,0)}function _(E,g){if(E.length==0)throw Error("number format error: empty string");if(g=g||10,g<2||36<g)throw Error("radix out of range: "+g);if(E.charAt(0)=="-")return N(_(E.substring(1),g));if(E.indexOf("-")>=0)throw Error('number format error: interior "-" character');const p=f(Math.pow(g,8));let T=I;for(let v=0;v<E.length;v+=8){var y=Math.min(8,E.length-v);const m=parseInt(E.substring(v,v+y),g);y<8?(y=f(Math.pow(g,y)),T=T.j(y).add(f(m))):(T=T.j(p),T=T.add(f(m)))}return T}var I=d(0),R=d(1),S=d(16777216);r=c.prototype,r.m=function(){if(M(this))return-N(this).m();let E=0,g=1;for(let p=0;p<this.g.length;p++){const T=this.i(p);E+=(T>=0?T:4294967296+T)*g,g*=4294967296}return E},r.toString=function(E){if(E=E||10,E<2||36<E)throw Error("radix out of range: "+E);if(k(this))return"0";if(M(this))return"-"+N(this).toString(E);const g=f(Math.pow(E,6));var p=this;let T="";for(;;){const y=Y(p,g).g;p=K(p,y.j(g));let v=((p.g.length>0?p.g[0]:p.h)>>>0).toString(E);if(p=y,k(p))return v+T;for(;v.length<6;)v="0"+v;T=v+T}},r.i=function(E){return E<0?0:E<this.g.length?this.g[E]:this.h};function k(E){if(E.h!=0)return!1;for(let g=0;g<E.g.length;g++)if(E.g[g]!=0)return!1;return!0}function M(E){return E.h==-1}r.l=function(E){return E=K(this,E),M(E)?-1:k(E)?0:1};function N(E){const g=E.g.length,p=[];for(let T=0;T<g;T++)p[T]=~E.g[T];return new c(p,~E.h).add(R)}r.abs=function(){return M(this)?N(this):this},r.add=function(E){const g=Math.max(this.g.length,E.g.length),p=[];let T=0;for(let y=0;y<=g;y++){let v=T+(this.i(y)&65535)+(E.i(y)&65535),m=(v>>>16)+(this.i(y)>>>16)+(E.i(y)>>>16);T=m>>>16,v&=65535,m&=65535,p[y]=m<<16|v}return new c(p,p[p.length-1]&-2147483648?-1:0)};function K(E,g){return E.add(N(g))}r.j=function(E){if(k(this)||k(E))return I;if(M(this))return M(E)?N(this).j(N(E)):N(N(this).j(E));if(M(E))return N(this.j(N(E)));if(this.l(S)<0&&E.l(S)<0)return f(this.m()*E.m());const g=this.g.length+E.g.length,p=[];for(var T=0;T<2*g;T++)p[T]=0;for(T=0;T<this.g.length;T++)for(let y=0;y<E.g.length;y++){const v=this.i(T)>>>16,m=this.i(T)&65535,rt=E.i(y)>>>16,ht=E.i(y)&65535;p[2*T+2*y]+=m*ht,z(p,2*T+2*y),p[2*T+2*y+1]+=v*ht,z(p,2*T+2*y+1),p[2*T+2*y+1]+=m*rt,z(p,2*T+2*y+1),p[2*T+2*y+2]+=v*rt,z(p,2*T+2*y+2)}for(E=0;E<g;E++)p[E]=p[2*E+1]<<16|p[2*E];for(E=g;E<2*g;E++)p[E]=0;return new c(p,0)};function z(E,g){for(;(E[g]&65535)!=E[g];)E[g+1]+=E[g]>>>16,E[g]&=65535,g++}function G(E,g){this.g=E,this.h=g}function Y(E,g){if(k(g))throw Error("division by zero");if(k(E))return new G(I,I);if(M(E))return g=Y(N(E),g),new G(N(g.g),N(g.h));if(M(g))return g=Y(E,N(g)),new G(N(g.g),g.h);if(E.g.length>30){if(M(E)||M(g))throw Error("slowDivide_ only works with positive integers.");for(var p=R,T=g;T.l(E)<=0;)p=at(p),T=at(T);var y=W(p,1),v=W(T,1);for(T=W(T,2),p=W(p,2);!k(T);){var m=v.add(T);m.l(E)<=0&&(y=y.add(p),v=m),T=W(T,1),p=W(p,1)}return g=K(E,y.j(g)),new G(y,g)}for(y=I;E.l(g)>=0;){for(p=Math.max(1,Math.floor(E.m()/g.m())),T=Math.ceil(Math.log(p)/Math.LN2),T=T<=48?1:Math.pow(2,T-48),v=f(p),m=v.j(g);M(m)||m.l(E)>0;)p-=T,v=f(p),m=v.j(g);k(v)&&(v=R),y=y.add(v),E=K(E,m)}return new G(y,E)}r.B=function(E){return Y(this,E).h},r.and=function(E){const g=Math.max(this.g.length,E.g.length),p=[];for(let T=0;T<g;T++)p[T]=this.i(T)&E.i(T);return new c(p,this.h&E.h)},r.or=function(E){const g=Math.max(this.g.length,E.g.length),p=[];for(let T=0;T<g;T++)p[T]=this.i(T)|E.i(T);return new c(p,this.h|E.h)},r.xor=function(E){const g=Math.max(this.g.length,E.g.length),p=[];for(let T=0;T<g;T++)p[T]=this.i(T)^E.i(T);return new c(p,this.h^E.h)};function at(E){const g=E.g.length+1,p=[];for(let T=0;T<g;T++)p[T]=E.i(T)<<1|E.i(T-1)>>>31;return new c(p,E.h)}function W(E,g){const p=g>>5;g%=32;const T=E.g.length-p,y=[];for(let v=0;v<T;v++)y[v]=g>0?E.i(v+p)>>>g|E.i(v+p+1)<<32-g:E.i(v+p);return new c(y,E.h)}n.prototype.digest=n.prototype.A,n.prototype.reset=n.prototype.u,n.prototype.update=n.prototype.v,Ia=n,c.prototype.add=c.prototype.add,c.prototype.multiply=c.prototype.j,c.prototype.modulo=c.prototype.B,c.prototype.compare=c.prototype.l,c.prototype.toNumber=c.prototype.m,c.prototype.toString=c.prototype.toString,c.prototype.getBits=c.prototype.i,c.fromNumber=f,c.fromString=_,Wt=c}).apply(typeof mo<"u"?mo:typeof self<"u"?self:typeof window<"u"?window:{});var Bn=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var wa,nn,Aa,Hn,cs,Ra,Ca,Sa;(function(){var r,t=Object.defineProperty;function e(s){s=[typeof globalThis=="object"&&globalThis,s,typeof window=="object"&&window,typeof self=="object"&&self,typeof Bn=="object"&&Bn];for(var a=0;a<s.length;++a){var u=s[a];if(u&&u.Math==Math)return u}throw Error("Cannot find global object")}var n=e(this);function i(s,a){if(a)t:{var u=n;s=s.split(".");for(var h=0;h<s.length-1;h++){var w=s[h];if(!(w in u))break t;u=u[w]}s=s[s.length-1],h=u[s],a=a(h),a!=h&&a!=null&&t(u,s,{configurable:!0,writable:!0,value:a})}}i("Symbol.dispose",function(s){return s||Symbol("Symbol.dispose")}),i("Array.prototype.values",function(s){return s||function(){return this[Symbol.iterator]()}}),i("Object.entries",function(s){return s||function(a){var u=[],h;for(h in a)Object.prototype.hasOwnProperty.call(a,h)&&u.push([h,a[h]]);return u}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},c=this||self;function l(s){var a=typeof s;return a=="object"&&s!=null||a=="function"}function d(s,a,u){return s.call.apply(s.bind,arguments)}function f(s,a,u){return f=d,f.apply(null,arguments)}function _(s,a){var u=Array.prototype.slice.call(arguments,1);return function(){var h=u.slice();return h.push.apply(h,arguments),s.apply(this,h)}}function I(s,a){function u(){}u.prototype=a.prototype,s.Z=a.prototype,s.prototype=new u,s.prototype.constructor=s,s.Ob=function(h,w,A){for(var b=Array(arguments.length-2),U=2;U<arguments.length;U++)b[U-2]=arguments[U];return a.prototype[w].apply(h,b)}}var R=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?s=>s&&AsyncContext.Snapshot.wrap(s):s=>s;function S(s){const a=s.length;if(a>0){const u=Array(a);for(let h=0;h<a;h++)u[h]=s[h];return u}return[]}function k(s,a){for(let h=1;h<arguments.length;h++){const w=arguments[h];var u=typeof w;if(u=u!="object"?u:w?Array.isArray(w)?"array":u:"null",u=="array"||u=="object"&&typeof w.length=="number"){u=s.length||0;const A=w.length||0;s.length=u+A;for(let b=0;b<A;b++)s[u+b]=w[b]}else s.push(w)}}class M{constructor(a,u){this.i=a,this.j=u,this.h=0,this.g=null}get(){let a;return this.h>0?(this.h--,a=this.g,this.g=a.next,a.next=null):a=this.i(),a}}function N(s){c.setTimeout(()=>{throw s},0)}function K(){var s=E;let a=null;return s.g&&(a=s.g,s.g=s.g.next,s.g||(s.h=null),a.next=null),a}class z{constructor(){this.h=this.g=null}add(a,u){const h=G.get();h.set(a,u),this.h?this.h.next=h:this.g=h,this.h=h}}var G=new M(()=>new Y,s=>s.reset());class Y{constructor(){this.next=this.g=this.h=null}set(a,u){this.h=a,this.g=u,this.next=null}reset(){this.next=this.g=this.h=null}}let at,W=!1,E=new z,g=()=>{const s=Promise.resolve(void 0);at=()=>{s.then(p)}};function p(){for(var s;s=K();){try{s.h.call(s.g)}catch(u){N(u)}var a=G;a.j(s),a.h<100&&(a.h++,s.next=a.g,a.g=s)}W=!1}function T(){this.u=this.u,this.C=this.C}T.prototype.u=!1,T.prototype.dispose=function(){this.u||(this.u=!0,this.N())},T.prototype[Symbol.dispose]=function(){this.dispose()},T.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function y(s,a){this.type=s,this.g=this.target=a,this.defaultPrevented=!1}y.prototype.h=function(){this.defaultPrevented=!0};var v=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var s=!1,a=Object.defineProperty({},"passive",{get:function(){s=!0}});try{const u=()=>{};c.addEventListener("test",u,a),c.removeEventListener("test",u,a)}catch{}return s}();function m(s){return/^[\s\xa0]*$/.test(s)}function rt(s,a){y.call(this,s?s.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,s&&this.init(s,a)}I(rt,y),rt.prototype.init=function(s,a){const u=this.type=s.type,h=s.changedTouches&&s.changedTouches.length?s.changedTouches[0]:null;this.target=s.target||s.srcElement,this.g=a,a=s.relatedTarget,a||(u=="mouseover"?a=s.fromElement:u=="mouseout"&&(a=s.toElement)),this.relatedTarget=a,h?(this.clientX=h.clientX!==void 0?h.clientX:h.pageX,this.clientY=h.clientY!==void 0?h.clientY:h.pageY,this.screenX=h.screenX||0,this.screenY=h.screenY||0):(this.clientX=s.clientX!==void 0?s.clientX:s.pageX,this.clientY=s.clientY!==void 0?s.clientY:s.pageY,this.screenX=s.screenX||0,this.screenY=s.screenY||0),this.button=s.button,this.key=s.key||"",this.ctrlKey=s.ctrlKey,this.altKey=s.altKey,this.shiftKey=s.shiftKey,this.metaKey=s.metaKey,this.pointerId=s.pointerId||0,this.pointerType=s.pointerType,this.state=s.state,this.i=s,s.defaultPrevented&&rt.Z.h.call(this)},rt.prototype.h=function(){rt.Z.h.call(this);const s=this.i;s.preventDefault?s.preventDefault():s.returnValue=!1};var ht="closure_listenable_"+(Math.random()*1e6|0),Ct=0;function Mt(s,a,u,h,w){this.listener=s,this.proxy=null,this.src=a,this.type=u,this.capture=!!h,this.ha=w,this.key=++Ct,this.da=this.fa=!1}function _e(s){s.da=!0,s.listener=null,s.proxy=null,s.src=null,s.ha=null}function Cn(s,a,u){for(const h in s)a.call(u,s[h],h,s)}function kc(s,a){for(const u in s)a.call(void 0,s[u],u,s)}function ei(s){const a={};for(const u in s)a[u]=s[u];return a}const ni="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function ri(s,a){let u,h;for(let w=1;w<arguments.length;w++){h=arguments[w];for(u in h)s[u]=h[u];for(let A=0;A<ni.length;A++)u=ni[A],Object.prototype.hasOwnProperty.call(h,u)&&(s[u]=h[u])}}function Sn(s){this.src=s,this.g={},this.h=0}Sn.prototype.add=function(s,a,u,h,w){const A=s.toString();s=this.g[A],s||(s=this.g[A]=[],this.h++);const b=yr(s,a,h,w);return b>-1?(a=s[b],u||(a.fa=!1)):(a=new Mt(a,this.src,A,!!h,w),a.fa=u,s.push(a)),a};function _r(s,a){const u=a.type;if(u in s.g){var h=s.g[u],w=Array.prototype.indexOf.call(h,a,void 0),A;(A=w>=0)&&Array.prototype.splice.call(h,w,1),A&&(_e(a),s.g[u].length==0&&(delete s.g[u],s.h--))}}function yr(s,a,u,h){for(let w=0;w<s.length;++w){const A=s[w];if(!A.da&&A.listener==a&&A.capture==!!u&&A.ha==h)return w}return-1}var Er="closure_lm_"+(Math.random()*1e6|0),Tr={};function si(s,a,u,h,w){if(Array.isArray(a)){for(let A=0;A<a.length;A++)si(s,a[A],u,h,w);return null}return u=ai(u),s&&s[ht]?s.J(a,u,l(h)?!!h.capture:!1,w):Oc(s,a,u,!1,h,w)}function Oc(s,a,u,h,w,A){if(!a)throw Error("Invalid event type");const b=l(w)?!!w.capture:!!w;let U=Ir(s);if(U||(s[Er]=U=new Sn(s)),u=U.add(a,u,h,b,A),u.proxy)return u;if(h=Mc(),u.proxy=h,h.src=s,h.listener=u,s.addEventListener)v||(w=b),w===void 0&&(w=!1),s.addEventListener(a.toString(),h,w);else if(s.attachEvent)s.attachEvent(oi(a.toString()),h);else if(s.addListener&&s.removeListener)s.addListener(h);else throw Error("addEventListener and attachEvent are unavailable.");return u}function Mc(){function s(u){return a.call(s.src,s.listener,u)}const a=Lc;return s}function ii(s,a,u,h,w){if(Array.isArray(a))for(var A=0;A<a.length;A++)ii(s,a[A],u,h,w);else h=l(h)?!!h.capture:!!h,u=ai(u),s&&s[ht]?(s=s.i,A=String(a).toString(),A in s.g&&(a=s.g[A],u=yr(a,u,h,w),u>-1&&(_e(a[u]),Array.prototype.splice.call(a,u,1),a.length==0&&(delete s.g[A],s.h--)))):s&&(s=Ir(s))&&(a=s.g[a.toString()],s=-1,a&&(s=yr(a,u,h,w)),(u=s>-1?a[s]:null)&&vr(u))}function vr(s){if(typeof s!="number"&&s&&!s.da){var a=s.src;if(a&&a[ht])_r(a.i,s);else{var u=s.type,h=s.proxy;a.removeEventListener?a.removeEventListener(u,h,s.capture):a.detachEvent?a.detachEvent(oi(u),h):a.addListener&&a.removeListener&&a.removeListener(h),(u=Ir(a))?(_r(u,s),u.h==0&&(u.src=null,a[Er]=null)):_e(s)}}}function oi(s){return s in Tr?Tr[s]:Tr[s]="on"+s}function Lc(s,a){if(s.da)s=!0;else{a=new rt(a,this);const u=s.listener,h=s.ha||s.src;s.fa&&vr(s),s=u.call(h,a)}return s}function Ir(s){return s=s[Er],s instanceof Sn?s:null}var wr="__closure_events_fn_"+(Math.random()*1e9>>>0);function ai(s){return typeof s=="function"?s:(s[wr]||(s[wr]=function(a){return s.handleEvent(a)}),s[wr])}function pt(){T.call(this),this.i=new Sn(this),this.M=this,this.G=null}I(pt,T),pt.prototype[ht]=!0,pt.prototype.removeEventListener=function(s,a,u,h){ii(this,s,a,u,h)};function Tt(s,a){var u,h=s.G;if(h)for(u=[];h;h=h.G)u.push(h);if(s=s.M,h=a.type||a,typeof a=="string")a=new y(a,s);else if(a instanceof y)a.target=a.target||s;else{var w=a;a=new y(h,s),ri(a,w)}w=!0;let A,b;if(u)for(b=u.length-1;b>=0;b--)A=a.g=u[b],w=Pn(A,h,!0,a)&&w;if(A=a.g=s,w=Pn(A,h,!0,a)&&w,w=Pn(A,h,!1,a)&&w,u)for(b=0;b<u.length;b++)A=a.g=u[b],w=Pn(A,h,!1,a)&&w}pt.prototype.N=function(){if(pt.Z.N.call(this),this.i){var s=this.i;for(const a in s.g){const u=s.g[a];for(let h=0;h<u.length;h++)_e(u[h]);delete s.g[a],s.h--}}this.G=null},pt.prototype.J=function(s,a,u,h){return this.i.add(String(s),a,!1,u,h)},pt.prototype.K=function(s,a,u,h){return this.i.add(String(s),a,!0,u,h)};function Pn(s,a,u,h){if(a=s.i.g[String(a)],!a)return!0;a=a.concat();let w=!0;for(let A=0;A<a.length;++A){const b=a[A];if(b&&!b.da&&b.capture==u){const U=b.listener,ct=b.ha||b.src;b.fa&&_r(s.i,b),w=U.call(ct,h)!==!1&&w}}return w&&!h.defaultPrevented}function Fc(s,a){if(typeof s!="function")if(s&&typeof s.handleEvent=="function")s=f(s.handleEvent,s);else throw Error("Invalid listener argument");return Number(a)>2147483647?-1:c.setTimeout(s,a||0)}function ci(s){s.g=Fc(()=>{s.g=null,s.i&&(s.i=!1,ci(s))},s.l);const a=s.h;s.h=null,s.m.apply(null,a)}class Uc extends T{constructor(a,u){super(),this.m=a,this.l=u,this.h=null,this.i=!1,this.g=null}j(a){this.h=arguments,this.g?this.i=!0:ci(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Be(s){T.call(this),this.h=s,this.g={}}I(Be,T);var ui=[];function li(s){Cn(s.g,function(a,u){this.g.hasOwnProperty(u)&&vr(a)},s),s.g={}}Be.prototype.N=function(){Be.Z.N.call(this),li(this)},Be.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ar=c.JSON.stringify,Bc=c.JSON.parse,jc=class{stringify(s){return c.JSON.stringify(s,void 0)}parse(s){return c.JSON.parse(s,void 0)}};function hi(){}function di(){}var je={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Rr(){y.call(this,"d")}I(Rr,y);function Cr(){y.call(this,"c")}I(Cr,y);var se={},fi=null;function bn(){return fi=fi||new pt}se.Ia="serverreachability";function gi(s){y.call(this,se.Ia,s)}I(gi,y);function qe(s){const a=bn();Tt(a,new gi(a))}se.STAT_EVENT="statevent";function mi(s,a){y.call(this,se.STAT_EVENT,s),this.stat=a}I(mi,y);function vt(s){const a=bn();Tt(a,new mi(a,s))}se.Ja="timingevent";function pi(s,a){y.call(this,se.Ja,s),this.size=a}I(pi,y);function $e(s,a){if(typeof s!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){s()},a)}function ze(){this.g=!0}ze.prototype.ua=function(){this.g=!1};function qc(s,a,u,h,w,A){s.info(function(){if(s.g)if(A){var b="",U=A.split("&");for(let Q=0;Q<U.length;Q++){var ct=U[Q].split("=");if(ct.length>1){const dt=ct[0];ct=ct[1];const bt=dt.split("_");b=bt.length>=2&&bt[1]=="type"?b+(dt+"="+ct+"&"):b+(dt+"=redacted&")}}}else b=null;else b=A;return"XMLHTTP REQ ("+h+") [attempt "+w+"]: "+a+`
`+u+`
`+b})}function $c(s,a,u,h,w,A,b){s.info(function(){return"XMLHTTP RESP ("+h+") [ attempt "+w+"]: "+a+`
`+u+`
`+A+" "+b})}function ye(s,a,u,h){s.info(function(){return"XMLHTTP TEXT ("+a+"): "+Hc(s,u)+(h?" "+h:"")})}function zc(s,a){s.info(function(){return"TIMEOUT: "+a})}ze.prototype.info=function(){};function Hc(s,a){if(!s.g)return a;if(!a)return null;try{const A=JSON.parse(a);if(A){for(s=0;s<A.length;s++)if(Array.isArray(A[s])){var u=A[s];if(!(u.length<2)){var h=u[1];if(Array.isArray(h)&&!(h.length<1)){var w=h[0];if(w!="noop"&&w!="stop"&&w!="close")for(let b=1;b<h.length;b++)h[b]=""}}}}return Ar(A)}catch{return a}}var Vn={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},_i={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},yi;function Sr(){}I(Sr,hi),Sr.prototype.g=function(){return new XMLHttpRequest},yi=new Sr;function He(s){return encodeURIComponent(String(s))}function Gc(s){var a=1;s=s.split(":");const u=[];for(;a>0&&s.length;)u.push(s.shift()),a--;return s.length&&u.push(s.join(":")),u}function Ut(s,a,u,h){this.j=s,this.i=a,this.l=u,this.S=h||1,this.V=new Be(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new Ei}function Ei(){this.i=null,this.g="",this.h=!1}var Ti={},Pr={};function br(s,a,u){s.M=1,s.A=Nn(Pt(a)),s.u=u,s.R=!0,vi(s,null)}function vi(s,a){s.F=Date.now(),Dn(s),s.B=Pt(s.A);var u=s.B,h=s.S;Array.isArray(h)||(h=[String(h)]),ki(u.i,"t",h),s.C=0,u=s.j.L,s.h=new Ei,s.g=Ji(s.j,u?a:null,!s.u),s.P>0&&(s.O=new Uc(f(s.Y,s,s.g),s.P)),a=s.V,u=s.g,h=s.ba;var w="readystatechange";Array.isArray(w)||(w&&(ui[0]=w.toString()),w=ui);for(let A=0;A<w.length;A++){const b=si(u,w[A],h||a.handleEvent,!1,a.h||a);if(!b)break;a.g[b.key]=b}a=s.J?ei(s.J):{},s.u?(s.v||(s.v="POST"),a["Content-Type"]="application/x-www-form-urlencoded",s.g.ea(s.B,s.v,s.u,a)):(s.v="GET",s.g.ea(s.B,s.v,null,a)),qe(),qc(s.i,s.v,s.B,s.l,s.S,s.u)}Ut.prototype.ba=function(s){s=s.target;const a=this.O;a&&qt(s)==3?a.j():this.Y(s)},Ut.prototype.Y=function(s){try{if(s==this.g)t:{const U=qt(this.g),ct=this.g.ya(),Q=this.g.ca();if(!(U<3)&&(U!=3||this.g&&(this.h.h||this.g.la()||ji(this.g)))){this.K||U!=4||ct==7||(ct==8||Q<=0?qe(3):qe(2)),Vr(this);var a=this.g.ca();this.X=a;var u=Kc(this);if(this.o=a==200,$c(this.i,this.v,this.B,this.l,this.S,U,a),this.o){if(this.U&&!this.L){e:{if(this.g){var h,w=this.g;if((h=w.g?w.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!m(h)){var A=h;break e}}A=null}if(s=A)ye(this.i,this.l,s,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Dr(this,s);else{this.o=!1,this.m=3,vt(12),ie(this),Ge(this);break t}}if(this.R){s=!0;let dt;for(;!this.K&&this.C<u.length;)if(dt=Qc(this,u),dt==Pr){U==4&&(this.m=4,vt(14),s=!1),ye(this.i,this.l,null,"[Incomplete Response]");break}else if(dt==Ti){this.m=4,vt(15),ye(this.i,this.l,u,"[Invalid Chunk]"),s=!1;break}else ye(this.i,this.l,dt,null),Dr(this,dt);if(Ii(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),U!=4||u.length!=0||this.h.h||(this.m=1,vt(16),s=!1),this.o=this.o&&s,!s)ye(this.i,this.l,u,"[Invalid Chunked Response]"),ie(this),Ge(this);else if(u.length>0&&!this.W){this.W=!0;var b=this.j;b.g==this&&b.aa&&!b.P&&(b.j.info("Great, no buffering proxy detected. Bytes received: "+u.length),Ur(b),b.P=!0,vt(11))}}else ye(this.i,this.l,u,null),Dr(this,u);U==4&&ie(this),this.o&&!this.K&&(U==4?Qi(this.j,this):(this.o=!1,Dn(this)))}else cu(this.g),a==400&&u.indexOf("Unknown SID")>0?(this.m=3,vt(12)):(this.m=0,vt(13)),ie(this),Ge(this)}}}catch{}finally{}};function Kc(s){if(!Ii(s))return s.g.la();const a=ji(s.g);if(a==="")return"";let u="";const h=a.length,w=qt(s.g)==4;if(!s.h.i){if(typeof TextDecoder>"u")return ie(s),Ge(s),"";s.h.i=new c.TextDecoder}for(let A=0;A<h;A++)s.h.h=!0,u+=s.h.i.decode(a[A],{stream:!(w&&A==h-1)});return a.length=0,s.h.g+=u,s.C=0,s.h.g}function Ii(s){return s.g?s.v=="GET"&&s.M!=2&&s.j.Aa:!1}function Qc(s,a){var u=s.C,h=a.indexOf(`
`,u);return h==-1?Pr:(u=Number(a.substring(u,h)),isNaN(u)?Ti:(h+=1,h+u>a.length?Pr:(a=a.slice(h,h+u),s.C=h+u,a)))}Ut.prototype.cancel=function(){this.K=!0,ie(this)};function Dn(s){s.T=Date.now()+s.H,wi(s,s.H)}function wi(s,a){if(s.D!=null)throw Error("WatchDog timer not null");s.D=$e(f(s.aa,s),a)}function Vr(s){s.D&&(c.clearTimeout(s.D),s.D=null)}Ut.prototype.aa=function(){this.D=null;const s=Date.now();s-this.T>=0?(zc(this.i,this.B),this.M!=2&&(qe(),vt(17)),ie(this),this.m=2,Ge(this)):wi(this,this.T-s)};function Ge(s){s.j.I==0||s.K||Qi(s.j,s)}function ie(s){Vr(s);var a=s.O;a&&typeof a.dispose=="function"&&a.dispose(),s.O=null,li(s.V),s.g&&(a=s.g,s.g=null,a.abort(),a.dispose())}function Dr(s,a){try{var u=s.j;if(u.I!=0&&(u.g==s||Nr(u.h,s))){if(!s.L&&Nr(u.h,s)&&u.I==3){try{var h=u.Ba.g.parse(a)}catch{h=null}if(Array.isArray(h)&&h.length==3){var w=h;if(w[0]==0){t:if(!u.v){if(u.g)if(u.g.F+3e3<s.F)Ln(u),On(u);else break t;Fr(u),vt(18)}}else u.xa=w[1],0<u.xa-u.K&&w[2]<37500&&u.F&&u.A==0&&!u.C&&(u.C=$e(f(u.Va,u),6e3));Ci(u.h)<=1&&u.ta&&(u.ta=void 0)}else ae(u,11)}else if((s.L||u.g==s)&&Ln(u),!m(a))for(w=u.Ba.g.parse(a),a=0;a<w.length;a++){let Q=w[a];const dt=Q[0];if(!(dt<=u.K))if(u.K=dt,Q=Q[1],u.I==2)if(Q[0]=="c"){u.M=Q[1],u.ba=Q[2];const bt=Q[3];bt!=null&&(u.ka=bt,u.j.info("VER="+u.ka));const ce=Q[4];ce!=null&&(u.za=ce,u.j.info("SVER="+u.za));const $t=Q[5];$t!=null&&typeof $t=="number"&&$t>0&&(h=1.5*$t,u.O=h,u.j.info("backChannelRequestTimeoutMs_="+h)),h=u;const zt=s.g;if(zt){const Un=zt.g?zt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Un){var A=h.h;A.g||Un.indexOf("spdy")==-1&&Un.indexOf("quic")==-1&&Un.indexOf("h2")==-1||(A.j=A.l,A.g=new Set,A.h&&(xr(A,A.h),A.h=null))}if(h.G){const Br=zt.g?zt.g.getResponseHeader("X-HTTP-Session-Id"):null;Br&&(h.wa=Br,X(h.J,h.G,Br))}}u.I=3,u.l&&u.l.ra(),u.aa&&(u.T=Date.now()-s.F,u.j.info("Handshake RTT: "+u.T+"ms")),h=u;var b=s;if(h.na=Yi(h,h.L?h.ba:null,h.W),b.L){Si(h.h,b);var U=b,ct=h.O;ct&&(U.H=ct),U.D&&(Vr(U),Dn(U)),h.g=b}else Gi(h);u.i.length>0&&Mn(u)}else Q[0]!="stop"&&Q[0]!="close"||ae(u,7);else u.I==3&&(Q[0]=="stop"||Q[0]=="close"?Q[0]=="stop"?ae(u,7):Lr(u):Q[0]!="noop"&&u.l&&u.l.qa(Q),u.A=0)}}qe(4)}catch{}}var Wc=class{constructor(s,a){this.g=s,this.map=a}};function Ai(s){this.l=s||10,c.PerformanceNavigationTiming?(s=c.performance.getEntriesByType("navigation"),s=s.length>0&&(s[0].nextHopProtocol=="hq"||s[0].nextHopProtocol=="h2")):s=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=s?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function Ri(s){return s.h?!0:s.g?s.g.size>=s.j:!1}function Ci(s){return s.h?1:s.g?s.g.size:0}function Nr(s,a){return s.h?s.h==a:s.g?s.g.has(a):!1}function xr(s,a){s.g?s.g.add(a):s.h=a}function Si(s,a){s.h&&s.h==a?s.h=null:s.g&&s.g.has(a)&&s.g.delete(a)}Ai.prototype.cancel=function(){if(this.i=Pi(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const s of this.g.values())s.cancel();this.g.clear()}};function Pi(s){if(s.h!=null)return s.i.concat(s.h.G);if(s.g!=null&&s.g.size!==0){let a=s.i;for(const u of s.g.values())a=a.concat(u.G);return a}return S(s.i)}var bi=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Xc(s,a){if(s){s=s.split("&");for(let u=0;u<s.length;u++){const h=s[u].indexOf("=");let w,A=null;h>=0?(w=s[u].substring(0,h),A=s[u].substring(h+1)):w=s[u],a(w,A?decodeURIComponent(A.replace(/\+/g," ")):"")}}}function Bt(s){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let a;s instanceof Bt?(this.l=s.l,Ke(this,s.j),this.o=s.o,this.g=s.g,Qe(this,s.u),this.h=s.h,kr(this,Oi(s.i)),this.m=s.m):s&&(a=String(s).match(bi))?(this.l=!1,Ke(this,a[1]||"",!0),this.o=We(a[2]||""),this.g=We(a[3]||"",!0),Qe(this,a[4]),this.h=We(a[5]||"",!0),kr(this,a[6]||"",!0),this.m=We(a[7]||"")):(this.l=!1,this.i=new Ye(null,this.l))}Bt.prototype.toString=function(){const s=[];var a=this.j;a&&s.push(Xe(a,Vi,!0),":");var u=this.g;return(u||a=="file")&&(s.push("//"),(a=this.o)&&s.push(Xe(a,Vi,!0),"@"),s.push(He(u).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),u=this.u,u!=null&&s.push(":",String(u))),(u=this.h)&&(this.g&&u.charAt(0)!="/"&&s.push("/"),s.push(Xe(u,u.charAt(0)=="/"?Zc:Jc,!0))),(u=this.i.toString())&&s.push("?",u),(u=this.m)&&s.push("#",Xe(u,eu)),s.join("")},Bt.prototype.resolve=function(s){const a=Pt(this);let u=!!s.j;u?Ke(a,s.j):u=!!s.o,u?a.o=s.o:u=!!s.g,u?a.g=s.g:u=s.u!=null;var h=s.h;if(u)Qe(a,s.u);else if(u=!!s.h){if(h.charAt(0)!="/")if(this.g&&!this.h)h="/"+h;else{var w=a.h.lastIndexOf("/");w!=-1&&(h=a.h.slice(0,w+1)+h)}if(w=h,w==".."||w==".")h="";else if(w.indexOf("./")!=-1||w.indexOf("/.")!=-1){h=w.lastIndexOf("/",0)==0,w=w.split("/");const A=[];for(let b=0;b<w.length;){const U=w[b++];U=="."?h&&b==w.length&&A.push(""):U==".."?((A.length>1||A.length==1&&A[0]!="")&&A.pop(),h&&b==w.length&&A.push("")):(A.push(U),h=!0)}h=A.join("/")}else h=w}return u?a.h=h:u=s.i.toString()!=="",u?kr(a,Oi(s.i)):u=!!s.m,u&&(a.m=s.m),a};function Pt(s){return new Bt(s)}function Ke(s,a,u){s.j=u?We(a,!0):a,s.j&&(s.j=s.j.replace(/:$/,""))}function Qe(s,a){if(a){if(a=Number(a),isNaN(a)||a<0)throw Error("Bad port number "+a);s.u=a}else s.u=null}function kr(s,a,u){a instanceof Ye?(s.i=a,nu(s.i,s.l)):(u||(a=Xe(a,tu)),s.i=new Ye(a,s.l))}function X(s,a,u){s.i.set(a,u)}function Nn(s){return X(s,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),s}function We(s,a){return s?a?decodeURI(s.replace(/%25/g,"%2525")):decodeURIComponent(s):""}function Xe(s,a,u){return typeof s=="string"?(s=encodeURI(s).replace(a,Yc),u&&(s=s.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),s):null}function Yc(s){return s=s.charCodeAt(0),"%"+(s>>4&15).toString(16)+(s&15).toString(16)}var Vi=/[#\/\?@]/g,Jc=/[#\?:]/g,Zc=/[#\?]/g,tu=/[#\?@]/g,eu=/#/g;function Ye(s,a){this.h=this.g=null,this.i=s||null,this.j=!!a}function oe(s){s.g||(s.g=new Map,s.h=0,s.i&&Xc(s.i,function(a,u){s.add(decodeURIComponent(a.replace(/\+/g," ")),u)}))}r=Ye.prototype,r.add=function(s,a){oe(this),this.i=null,s=Ee(this,s);let u=this.g.get(s);return u||this.g.set(s,u=[]),u.push(a),this.h+=1,this};function Di(s,a){oe(s),a=Ee(s,a),s.g.has(a)&&(s.i=null,s.h-=s.g.get(a).length,s.g.delete(a))}function Ni(s,a){return oe(s),a=Ee(s,a),s.g.has(a)}r.forEach=function(s,a){oe(this),this.g.forEach(function(u,h){u.forEach(function(w){s.call(a,w,h,this)},this)},this)};function xi(s,a){oe(s);let u=[];if(typeof a=="string")Ni(s,a)&&(u=u.concat(s.g.get(Ee(s,a))));else for(s=Array.from(s.g.values()),a=0;a<s.length;a++)u=u.concat(s[a]);return u}r.set=function(s,a){return oe(this),this.i=null,s=Ee(this,s),Ni(this,s)&&(this.h-=this.g.get(s).length),this.g.set(s,[a]),this.h+=1,this},r.get=function(s,a){return s?(s=xi(this,s),s.length>0?String(s[0]):a):a};function ki(s,a,u){Di(s,a),u.length>0&&(s.i=null,s.g.set(Ee(s,a),S(u)),s.h+=u.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const s=[],a=Array.from(this.g.keys());for(let h=0;h<a.length;h++){var u=a[h];const w=He(u);u=xi(this,u);for(let A=0;A<u.length;A++){let b=w;u[A]!==""&&(b+="="+He(u[A])),s.push(b)}}return this.i=s.join("&")};function Oi(s){const a=new Ye;return a.i=s.i,s.g&&(a.g=new Map(s.g),a.h=s.h),a}function Ee(s,a){return a=String(a),s.j&&(a=a.toLowerCase()),a}function nu(s,a){a&&!s.j&&(oe(s),s.i=null,s.g.forEach(function(u,h){const w=h.toLowerCase();h!=w&&(Di(this,h),ki(this,w,u))},s)),s.j=a}function ru(s,a){const u=new ze;if(c.Image){const h=new Image;h.onload=_(jt,u,"TestLoadImage: loaded",!0,a,h),h.onerror=_(jt,u,"TestLoadImage: error",!1,a,h),h.onabort=_(jt,u,"TestLoadImage: abort",!1,a,h),h.ontimeout=_(jt,u,"TestLoadImage: timeout",!1,a,h),c.setTimeout(function(){h.ontimeout&&h.ontimeout()},1e4),h.src=s}else a(!1)}function su(s,a){const u=new ze,h=new AbortController,w=setTimeout(()=>{h.abort(),jt(u,"TestPingServer: timeout",!1,a)},1e4);fetch(s,{signal:h.signal}).then(A=>{clearTimeout(w),A.ok?jt(u,"TestPingServer: ok",!0,a):jt(u,"TestPingServer: server error",!1,a)}).catch(()=>{clearTimeout(w),jt(u,"TestPingServer: error",!1,a)})}function jt(s,a,u,h,w){try{w&&(w.onload=null,w.onerror=null,w.onabort=null,w.ontimeout=null),h(u)}catch{}}function iu(){this.g=new jc}function Or(s){this.i=s.Sb||null,this.h=s.ab||!1}I(Or,hi),Or.prototype.g=function(){return new xn(this.i,this.h)};function xn(s,a){pt.call(this),this.H=s,this.o=a,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}I(xn,pt),r=xn.prototype,r.open=function(s,a){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=s,this.D=a,this.readyState=1,Ze(this)},r.send=function(s){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const a={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};s&&(a.body=s),(this.H||c).fetch(new Request(this.D,a)).then(this.Pa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Je(this)),this.readyState=0},r.Pa=function(s){if(this.g&&(this.l=s,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=s.headers,this.readyState=2,Ze(this)),this.g&&(this.readyState=3,Ze(this),this.g)))if(this.responseType==="arraybuffer")s.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in s){if(this.j=s.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Mi(this)}else s.text().then(this.Oa.bind(this),this.ga.bind(this))};function Mi(s){s.j.read().then(s.Ma.bind(s)).catch(s.ga.bind(s))}r.Ma=function(s){if(this.g){if(this.o&&s.value)this.response.push(s.value);else if(!this.o){var a=s.value?s.value:new Uint8Array(0);(a=this.B.decode(a,{stream:!s.done}))&&(this.response=this.responseText+=a)}s.done?Je(this):Ze(this),this.readyState==3&&Mi(this)}},r.Oa=function(s){this.g&&(this.response=this.responseText=s,Je(this))},r.Na=function(s){this.g&&(this.response=s,Je(this))},r.ga=function(){this.g&&Je(this)};function Je(s){s.readyState=4,s.l=null,s.j=null,s.B=null,Ze(s)}r.setRequestHeader=function(s,a){this.A.append(s,a)},r.getResponseHeader=function(s){return this.h&&this.h.get(s.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const s=[],a=this.h.entries();for(var u=a.next();!u.done;)u=u.value,s.push(u[0]+": "+u[1]),u=a.next();return s.join(`\r
...
`}),a}function Mr(s,a,u){t:{for(h in u){var h=!1;break t}h=!0}h||(u=Li(u),typeof s=="string"?u!=null&&He(u):X(s,a,u))}function tt(s){pt.call(this),this.headers=new Map,this.L=s||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}I(tt,pt);var ou=/^https?$/i,au=["POST","PUT"];r=tt.prototype,r.Fa=function(s){this.H=s},r.ea=function(s,a,u,h){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+s);a=a?a.toUpperCase():"GET",this.D=s,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():yi.g(),this.g.onreadystatechange=R(f(this.Ca,this));try{this.B=!0,this.g.open(a,String(s),!0),this.B=!1}catch(A){Fi(this,A);return}if(s=u||"",u=new Map(this.headers),h)if(Object.getPrototypeOf(h)===Object.prototype)for(var w in h)u.set(w,h[w]);else if(typeof h.keys=="function"&&typeof h.get=="function")for(const A of h.keys())u.set(A,h.get(A));else throw Error("Unknown input type for opt_headers: "+String(h));h=Array.from(u.keys()).find(A=>A.toLowerCase()=="content-type"),w=c.FormData&&s instanceof c.FormData,!(Array.prototype.indexOf.call(au,a,void 0)>=0)||h||w||u.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[A,b]of u)this.g.setRequestHeader(A,b);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(s),this.v=!1}catch(A){Fi(this,A)}};function Fi(s,a){s.h=!1,s.g&&(s.j=!0,s.g.abort(),s.j=!1),s.l=a,s.o=5,Ui(s),kn(s)}function Ui(s){s.A||(s.A=!0,Tt(s,"complete"),Tt(s,"error"))}r.abort=function(s){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=s||7,Tt(this,"complete"),Tt(this,"abort"),kn(this))},r.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),kn(this,!0)),tt.Z.N.call(this)},r.Ca=function(){this.u||(this.B||this.v||this.j?Bi(this):this.Xa())},r.Xa=function(){Bi(this)};function Bi(s){if(s.h&&typeof o<"u"){if(s.v&&qt(s)==4)setTimeout(s.Ca.bind(s),0);else if(Tt(s,"readystatechange"),qt(s)==4){s.h=!1;try{const A=s.ca();t:switch(A){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var a=!0;break t;default:a=!1}var u;if(!(u=a)){var h;if(h=A===0){let b=String(s.D).match(bi)[1]||null;!b&&c.self&&c.self.location&&(b=c.self.location.protocol.slice(0,-1)),h=!ou.test(b?b.toLowerCase():"")}u=h}if(u)Tt(s,"complete"),Tt(s,"success");else{s.o=6;try{var w=qt(s)>2?s.g.statusText:""}catch{w=""}s.l=w+" ["+s.ca()+"]",Ui(s)}}finally{kn(s)}}}}function kn(s,a){if(s.g){s.m&&(clearTimeout(s.m),s.m=null);const u=s.g;s.g=null,a||Tt(s,"ready");try{u.onreadystatechange=null}catch{}}}r.isActive=function(){return!!this.g};function qt(s){return s.g?s.g.readyState:0}r.ca=function(){try{return qt(this)>2?this.g.status:-1}catch{return-1}},r.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},r.La=function(s){if(this.g){var a=this.g.responseText;return s&&a.indexOf(s)==0&&(a=a.substring(s.length)),Bc(a)}};function ji(s){try{if(!s.g)return null;if("response"in s.g)return s.g.response;switch(s.F){case"":case"text":return s.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in s.g)return s.g.mozResponseArrayBuffer}return null}catch{return null}}function cu(s){const a={};s=(s.g&&qt(s)>=2&&s.g.getAllResponseHeaders()||"").split(`\r
`);for(let h=0;h<s.length;h++){if(m(s[h]))continue;var u=Gc(s[h]);const w=u[0];if(u=u[1],typeof u!="string")continue;u=u.trim();const A=a[w]||[];a[w]=A,A.push(u)}kc(a,function(h){return h.join(", ")})}r.ya=function(){return this.o},r.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function tn(s,a,u){return u&&u.internalChannelParams&&u.internalChannelParams[s]||a}function qi(s){this.za=0,this.i=[],this.j=new ze,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=tn("failFast",!1,s),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=tn("baseRetryDelayMs",5e3,s),this.Za=tn("retryDelaySeedMs",1e4,s),this.Ta=tn("forwardChannelMaxRetries",2,s),this.va=tn("forwardChannelRequestTimeoutMs",2e4,s),this.ma=s&&s.xmlHttpFactory||void 0,this.Ua=s&&s.Rb||void 0,this.Aa=s&&s.useFetchStreams||!1,this.O=void 0,this.L=s&&s.supportsCrossDomainXhr||!1,this.M="",this.h=new Ai(s&&s.concurrentRequestLimit),this.Ba=new iu,this.S=s&&s.fastHandshake||!1,this.R=s&&s.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=s&&s.Pb||!1,s&&s.ua&&this.j.ua(),s&&s.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&s&&s.detectBufferingProxy||!1,this.ia=void 0,s&&s.longPollingTimeout&&s.longPollingTimeout>0&&(this.ia=s.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}r=qi.prototype,r.ka=8,r.I=1,r.connect=function(s,a,u,h){vt(0),this.W=s,this.H=a||{},u&&h!==void 0&&(this.H.OSID=u,this.H.OAID=h),this.F=this.X,this.J=Yi(this,null,this.W),Mn(this)};function Lr(s){if($i(s),s.I==3){var a=s.V++,u=Pt(s.J);if(X(u,"SID",s.M),X(u,"RID",a),X(u,"TYPE","terminate"),en(s,u),a=new Ut(s,s.j,a),a.M=2,a.A=Nn(Pt(u)),u=!1,c.navigator&&c.navigator.sendBeacon)try{u=c.navigator.sendBeacon(a.A.toString(),"")}catch{}!u&&c.Image&&(new Image().src=a.A,u=!0),u||(a.g=Ji(a.j,null),a.g.ea(a.A)),a.F=Date.now(),Dn(a)}Xi(s)}function On(s){s.g&&(Ur(s),s.g.cancel(),s.g=null)}function $i(s){On(s),s.v&&(c.clearTimeout(s.v),s.v=null),Ln(s),s.h.cancel(),s.m&&(typeof s.m=="number"&&c.clearTimeout(s.m),s.m=null)}function Mn(s){if(!Ri(s.h)&&!s.m){s.m=!0;var a=s.Ea;at||g(),W||(at(),W=!0),E.add(a,s),s.D=0}}function uu(s,a){return Ci(s.h)>=s.h.j-(s.m?1:0)?!1:s.m?(s.i=a.G.concat(s.i),!0):s.I==1||s.I==2||s.D>=(s.Sa?0:s.Ta)?!1:(s.m=$e(f(s.Ea,s,a),Wi(s,s.D)),s.D++,!0)}r.Ea=function(s){if(this.m)if(this.m=null,this.I==1){if(!s){this.V=Math.floor(Math.random()*1e5),s=this.V++;const w=new Ut(this,this.j,s);let A=this.o;if(this.U&&(A?(A=ei(A),ri(A,this.U)):A=this.U),this.u!==null||this.R||(w.J=A,A=null),this.S)t:{for(var a=0,u=0;u<this.i.length;u++){e:{var h=this.i[u];if("__data__"in h.map&&(h=h.map.__data__,typeof h=="string")){h=h.length;break e}h=void 0}if(h===void 0)break;if(a+=h,a>4096){a=u;break t}if(a===4096||u===this.i.length-1){a=u+1;break t}}a=1e3}else a=1e3;a=Hi(this,w,a),u=Pt(this.J),X(u,"RID",s),X(u,"CVER",22),this.G&&X(u,"X-HTTP-Session-Id",this.G),en(this,u),A&&(this.R?a="headers="+He(Li(A))+"&"+a:this.u&&Mr(u,this.u,A)),xr(this.h,w),this.Ra&&X(u,"TYPE","init"),this.S?(X(u,"$req",a),X(u,"SID","null"),w.U=!0,br(w,u,null)):br(w,u,a),this.I=2}}else this.I==3&&(s?zi(this,s):this.i.length==0||Ri(this.h)||zi(this))};function zi(s,a){var u;a?u=a.l:u=s.V++;const h=Pt(s.J);X(h,"SID",s.M),X(h,"RID",u),X(h,"AID",s.K),en(s,h),s.u&&s.o&&Mr(h,s.u,s.o),u=new Ut(s,s.j,u,s.D+1),s.u===null&&(u.J=s.o),a&&(s.i=a.G.concat(s.i)),a=Hi(s,u,1e3),u.H=Math.round(s.va*.5)+Math.round(s.va*.5*Math.random()),xr(s.h,u),br(u,h,a)}function en(s,a){s.H&&Cn(s.H,function(u,h){X(a,h,u)}),s.l&&Cn({},function(u,h){X(a,h,u)})}function Hi(s,a,u){u=Math.min(s.i.length,u);const h=s.l?f(s.l.Ka,s.l,s):null;t:{var w=s.i;let U=-1;for(;;){const ct=["count="+u];U==-1?u>0?(U=w[0].g,ct.push("ofs="+U)):U=0:ct.push("ofs="+U);let Q=!0;for(let dt=0;dt<u;dt++){var A=w[dt].g;const bt=w[dt].map;if(A-=U,A<0)U=Math.max(0,w[dt].g-100),Q=!1;else try{A="req"+A+"_"||"";try{var b=bt instanceof Map?bt:Object.entries(bt);for(const[ce,$t]of b){let zt=$t;l($t)&&(zt=Ar($t)),ct.push(A+ce+"="+encodeURIComponent(zt))}}catch(ce){throw ct.push(A+"type="+encodeURIComponent("_badmap")),ce}}catch{h&&h(bt)}}if(Q){b=ct.join("&");break t}}b=void 0}return s=s.i.splice(0,u),a.G=s,b}function Gi(s){if(!s.g&&!s.v){s.Y=1;var a=s.Da;at||g(),W||(at(),W=!0),E.add(a,s),s.A=0}}function Fr(s){return s.g||s.v||s.A>=3?!1:(s.Y++,s.v=$e(f(s.Da,s),Wi(s,s.A)),s.A++,!0)}r.Da=function(){if(this.v=null,Ki(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var s=4*this.T;this.j.info("BP detection timer enabled: "+s),this.B=$e(f(this.Wa,this),s)}},r.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,vt(10),On(this),Ki(this))};function Ur(s){s.B!=null&&(c.clearTimeout(s.B),s.B=null)}function Ki(s){s.g=new Ut(s,s.j,"rpc",s.Y),s.u===null&&(s.g.J=s.o),s.g.P=0;var a=Pt(s.na);X(a,"RID","rpc"),X(a,"SID",s.M),X(a,"AID",s.K),X(a,"CI",s.F?"0":"1"),!s.F&&s.ia&&X(a,"TO",s.ia),X(a,"TYPE","xmlhttp"),en(s,a),s.u&&s.o&&Mr(a,s.u,s.o),s.O&&(s.g.H=s.O);var u=s.g;s=s.ba,u.M=1,u.A=Nn(Pt(a)),u.u=null,u.R=!0,vi(u,s)}r.Va=function(){this.C!=null&&(this.C=null,On(this),Fr(this),vt(19))};function Ln(s){s.C!=null&&(c.clearTimeout(s.C),s.C=null)}function Qi(s,a){var u=null;if(s.g==a){Ln(s),Ur(s),s.g=null;var h=2}else if(Nr(s.h,a))u=a.G,Si(s.h,a),h=1;else return;if(s.I!=0){if(a.o)if(h==1){u=a.u?a.u.length:0,a=Date.now()-a.F;var w=s.D;h=bn(),Tt(h,new pi(h,u)),Mn(s)}else Gi(s);else if(w=a.m,w==3||w==0&&a.X>0||!(h==1&&uu(s,a)||h==2&&Fr(s)))switch(u&&u.length>0&&(a=s.h,a.i=a.i.concat(u)),w){case 1:ae(s,5);break;case 4:ae(s,10);break;case 3:ae(s,6);break;default:ae(s,2)}}}function Wi(s,a){let u=s.Qa+Math.floor(Math.random()*s.Za);return s.isActive()||(u*=2),u*a}function ae(s,a){if(s.j.info("Error code "+a),a==2){var u=f(s.bb,s),h=s.Ua;const w=!h;h=new Bt(h||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||Ke(h,"https"),Nn(h),w?ru(h.toString(),u):su(h.toString(),u)}else vt(2);s.I=0,s.l&&s.l.pa(a),Xi(s),$i(s)}r.bb=function(s){s?(this.j.info("Successfully pinged google.com"),vt(2)):(this.j.info("Failed to ping google.com"),vt(1))};function Xi(s){if(s.I=0,s.ja=[],s.l){const a=Pi(s.h);(a.length!=0||s.i.length!=0)&&(k(s.ja,a),k(s.ja,s.i),s.h.i.length=0,S(s.i),s.i.length=0),s.l.oa()}}function Yi(s,a,u){var h=u instanceof Bt?Pt(u):new Bt(u);if(h.g!="")a&&(h.g=a+"."+h.g),Qe(h,h.u);else{var w=c.location;h=w.protocol,a=a?a+"."+w.hostname:w.hostname,w=+w.port;const A=new Bt(null);h&&Ke(A,h),a&&(A.g=a),w&&Qe(A,w),u&&(A.h=u),h=A}return u=s.G,a=s.wa,u&&a&&X(h,u,a),X(h,"VER",s.ka),en(s,h),h}function Ji(s,a,u){if(a&&!s.L)throw Error("Can't create secondary domain capable XhrIo object.");return a=s.Aa&&!s.ma?new tt(new Or({ab:u})):new tt(s.ma),a.Fa(s.L),a}r.isActive=function(){return!!this.l&&this.l.isActive(this)};function Zi(){}r=Zi.prototype,r.ra=function(){},r.qa=function(){},r.pa=function(){},r.oa=function(){},r.isActive=function(){return!0},r.Ka=function(){};function Fn(){}Fn.prototype.g=function(s,a){return new Rt(s,a)};function Rt(s,a){pt.call(this),this.g=new qi(a),this.l=s,this.h=a&&a.messageUrlParams||null,s=a&&a.messageHeaders||null,a&&a.clientProtocolHeaderRequired&&(s?s["X-Client-Protocol"]="webchannel":s={"X-Client-Protocol":"webchannel"}),this.g.o=s,s=a&&a.initMessageHeaders||null,a&&a.messageContentType&&(s?s["X-WebChannel-Content-Type"]=a.messageContentType:s={"X-WebChannel-Content-Type":a.messageContentType}),a&&a.sa&&(s?s["X-WebChannel-Client-Profile"]=a.sa:s={"X-WebChannel-Client-Profile":a.sa}),this.g.U=s,(s=a&&a.Qb)&&!m(s)&&(this.g.u=s),this.A=a&&a.supportsCrossDomainXhr||!1,this.v=a&&a.sendRawJson||!1,(a=a&&a.httpSessionIdParam)&&!m(a)&&(this.g.G=a,s=this.h,s!==null&&a in s&&(s=this.h,a in s&&delete s[a])),this.j=new Te(this)}I(Rt,pt),Rt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},Rt.prototype.close=function(){Lr(this.g)},Rt.prototype.o=function(s){var a=this.g;if(typeof s=="string"){var u={};u.__data__=s,s=u}else this.v&&(u={},u.__data__=Ar(s),s=u);a.i.push(new Wc(a.Ya++,s)),a.I==3&&Mn(a)},Rt.prototype.N=function(){this.g.l=null,delete this.j,Lr(this.g),delete this.g,Rt.Z.N.call(this)};function to(s){Rr.call(this),s.__headers__&&(this.headers=s.__headers__,this.statusCode=s.__status__,delete s.__headers__,delete s.__status__);var a=s.__sm__;if(a){t:{for(const u in a){s=u;break t}s=void 0}(this.i=s)&&(s=this.i,a=a!==null&&s in a?a[s]:void 0),this.data=a}else this.data=s}I(to,Rr);function eo(){Cr.call(this),this.status=1}I(eo,Cr);function Te(s){this.g=s}I(Te,Zi),Te.prototype.ra=function(){Tt(this.g,"a")},Te.prototype.qa=function(s){Tt(this.g,new to(s))},Te.prototype.pa=function(s){Tt(this.g,new eo)},Te.prototype.oa=function(){Tt(this.g,"b")},Fn.prototype.createWebChannel=Fn.prototype.g,Rt.prototype.send=Rt.prototype.o,Rt.prototype.open=Rt.prototype.m,Rt.prototype.close=Rt.prototype.close,Sa=function(){return new Fn},Ca=function(){return bn()},Ra=se,cs={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Vn.NO_ERROR=0,Vn.TIMEOUT=8,Vn.HTTP_ERROR=6,Hn=Vn,_i.COMPLETE="complete",Aa=_i,di.EventType=je,je.OPEN="a",je.CLOSE="b",je.ERROR="c",je.MESSAGE="d",pt.prototype.listen=pt.prototype.J,nn=di,tt.prototype.listenOnce=tt.prototype.K,tt.prototype.getLastError=tt.prototype.Ha,tt.prototype.getLastErrorCode=tt.prototype.ya,tt.prototype.getStatus=tt.prototype.ca,tt.prototype.getResponseJson=tt.prototype.La,tt.prototype.getResponseText=tt.prototype.la,tt.prototype.send=tt.prototype.ea,tt.prototype.setWithCredentials=tt.prototype.Fa,wa=tt}).apply(typeof Bn<"u"?Bn:typeof self<"u"?self:typeof window<"u"?window:{});const po="@firebase/firestore",_o="4.9.2";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const me=new pa("@firebase/firestore");function Ie(){return me.logLevel}function V(r,...t){if(me.logLevel<=q.DEBUG){const e=t.map(Vs);me.debug(`Firestore (${Le}): ${r}`,...e)}}function Ft(r,...t){if(me.logLevel<=q.ERROR){const e=t.map(Vs);me.error(`Firestore (${Le}): ${r}`,...e)}}function be(r,...t){if(me.logLevel<=q.WARN){const e=t.map(Vs);me.warn(`Firestore (${Le}): ${r}`,...e)}}function Vs(r){if(typeof r=="string")return r;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F(r,t,e){let n="Unexpected state";typeof t=="string"?n=t:e=t,Pa(r,n,e)}function Pa(r,t,e){let n=`FIRESTORE (${Le}) INTERNAL ASSERTION FAILED: ${t} (ID: ${r.toString(16)})`;if(e!==void 0)try{n+=" CONTEXT: "+JSON.stringify(e)}catch{n+=" CONTEXT: "+e}throw Ft(n),new Error(n)}function Z(r,t,e,n){let i="Unexpected state";typeof e=="string"?i=e:n=e,r||Pa(t,i,n)}function $(r,t){return r}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ma{}class ut extends Ma{constructor(t,e,n){super(),this.field=t,this.op=e,this.value=n}static create(t,e,n){return t.isKeyField()?e==="in"||e==="not-in"?this.createKeyFieldInFilter(t,e,n):new bh(t,e,n):e==="array-contains"?new Nh(t,n):e==="in"?new xh(t,n):e==="not-in"?new kh(t,n):e==="array-contains-any"?new Oh(t,n):new ut(t,e,n)}static createKeyFieldInFilter(t,e,n){return e==="in"?new Vh(t,n):new Dh(t,n)}matches(t){const e=t.data.field(this.field);return this.op==="!="?e!==null&&e.nullValue===void 0&&this.matchesComparison(De(e,this.value)):e!==null&&ee(this.value)===ee(e)&&this.matchesComparison(De(e,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return F(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Ot extends Ma{constructor(t,e){super(),this.filters=t,this.op=e,this.Pe=null}static create(t,e){return new Ot(t,e)}matches(t){return La(this)?this.filters.find(e=>!e.matches(t))===void 0:this.filters.find(e=>e.matches(t))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce((t,e)=>t.concat(e.getFlattenedFilters()),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function La(r){return r.op==="and"}function Fa(r){return Ph(r)&&La(r)}function Ph(r){for(const t of r.filters)if(t instanceof Ot)return!1;return!0}function ms(r){if(r instanceof ut)return r.field.canonicalString()+r.op.toString()+Ne(r.value);if(Fa(r))return r.filters.map(t=>ms(t)).join(",");{const t=r.filters.map(e=>ms(e)).join(",");return`${r.op}(${t})`}}function Ua(r,t){return r instanceof ut?function(n,i){return i instanceof ut&&n.op===i.op&&n.field.isEqual(i.field)&&kt(n.value,i.value)}(r,t):r instanceof Ot?function(n,i){return i instanceof Ot&&n.op===i.op&&n.filters.length===i.filters.length?n.filters.reduce((o,c,l)=>o&&Ua(c,i.filters[l]),!0):!1}(r,t):void F(19439)}function Ba(r){return r instanceof ut?function(e){return`${e.field.canonicalString()} ${e.op} ${Ne(e.value)}`}(r):r instanceof Ot?function(e){return e.op.toString()+" {"+e.getFilters().map(Ba).join(" ,")+"}"}(r):"Filter"}class bh extends ut{constructor(t,e,n){super(t,e,n),this.key=O.fromName(n.referenceValue)}matches(t){const e=O.comparator(t.key,this.key);return this.matchesComparison(e)}}class Vh extends ut{constructor(t,e){super(t,"in",e),this.keys=ja("in",e)}matches(t){return this.keys.some(e=>e.isEqual(t.key))}}class Dh extends ut{constructor(t,e){super(t,"not-in",e),this.keys=ja("not-in",e)}matches(t){return!this.keys.some(e=>e.isEqual(t.key))}}function ja(r,t){var e;return(((e=t.arrayValue)==null?void 0:e.values)||[]).map(n=>O.fromName(n.referenceValue))}class Nh extends ut{constructor(t,e){super(t,"array-contains",e)}matches(t){const e=t.data.field(this.field);return xs(e)&&En(e.arrayValue,this.value)}}class xh extends ut{constructor(t,e){super(t,"in",e)}matches(t){const e=t.data.field(this.field);return e!==null&&En(this.value.arrayValue,e)}}class kh extends ut{constructor(t,e){super(t,"not-in",e)}matches(t){if(En(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const e=t.data.field(this.field);return e!==null&&e.nullValue===void 0&&!En(this.value.arrayValue,e)}}class Oh extends ut{constructor(t,e){super(t,"array-contains-any",e)}matches(t){const e=t.data.field(this.field);return!(!xs(e)||!e.arrayValue.values)&&e.arrayValue.values.some(n=>En(this.value.arrayValue,n))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mr{constructor(t,e,n,i,o){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=n,this.documentUpdates=i,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(t,e,n){const i=new Map;return i.set(t,wn.createSynthesizedTargetChangeForCurrentChange(t,e,n)),new mr(L.min(),i,new nt(B),ne(),H())}}class wn{constructor(t,e,n,i,o){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=i,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(t,e,n){return new wn(n,e,H(),H(),H())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kd{constructor(t,e,n,i){this.remoteDocumentCache=t,this.mutationQueue=e,this.documentOverlayCache=n,this.indexManager=i}getDocument(t,e){let n=null;return this.documentOverlayCache.getOverlay(t,e).next(i=>(n=i,this.remoteDocumentCache.getEntry(t,e))).next(i=>(n!==null&&hn(n.mutation,i,Ht.empty(),it.now()),i))}getDocuments(t,e){return this.remoteDocumentCache.getEntries(t,e).next(n=>this.getLocalViewOfDocuments(t,n,H()).next(()=>n))}getLocalViewOfDocuments(t,e,n=H()){const i=le();return this.populateOverlays(t,i,e).next(()=>this.computeViews(t,e,i,n).next(o=>{let c=rn();return o.forEach((l,d)=>{c=c.insert(l,d.overlayedDocument)}),c}))}getOverlayedDocuments(t,e){const n=le();return this.populateOverlays(t,n,e).next(()=>this.computeViews(t,e,n,H()))}populateOverlays(t,e,n){const i=[];return n.forEach(o=>{e.has(o)||i.push(o)}),this.documentOverlayCache.getOverlays(t,i).next(o=>{o.forEach((c,l)=>{e.set(c,l)})})}computeViews(t,e,n,i){let o=ne();const c=ln(),l=function(){return ln()}();return e.forEach((d,f)=>{const _=n.get(f.key);i.has(f.key)&&(_===void 0||_.mutation instanceof gr)?o=o.insert(f.key,f):_!==void 0?(c.set(f.key,_.mutation.getFieldMask()),hn(_.mutation,f,_.mutation.getFieldMask(),it.now())):c.set(f.key,Ht.empty())}),this.recalculateAndSaveOverlays(t,o).next(d=>(d.forEach((f,_)=>c.set(f,_)),e.forEach((f,_)=>l.set(f,new xd(_,c.get(f)??null))),l))}recalculateAndSaveOverlays(t,e){const n=ln();let i=new nt((c,l)=>c-l),o=H();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(t,e).next(c=>{for(const l of c)l.keys().forEach(d=>{const f=e.get(d);if(f===null)return;let _=n.get(d)||Ht.empty();_=l.applyToLocalView(f,_),n.set(d,_);const I=(i.get(l.batchId)||H()).add(d);i=i.insert(l.batchId,I)})}).next(()=>{const c=[],l=i.getReverseIterator();for(;l.hasNext();){const d=l.getNext(),f=d.key,_=d.value,I=Ha();_.forEach(R=>{if(!o.has(R)){const S=Wa(e.get(R),n.get(R));S!==null&&I.set(R,S),o=o.add(R)}}),c.push(this.documentOverlayCache.saveOverlays(t,f,I))}return C.waitFor(c)}).next(()=>n)}recalculateAndSaveOverlaysForDocumentKeys(t,e){return this.remoteDocumentCache.getEntries(t,e).next(n=>this.recalculateAndSaveOverlays(t,n))}getDocumentsMatchingQuery(t,e,n,i){return function(c){return O.isDocumentKey(c.path)&&c.collectionGroup===null&&c.filters.length===0}(e)?this.getDocumentsMatchingDocumentQuery(t,e.path):Fh(e)?this.getDocumentsMatchingCollectionGroupQuery(t,e,n,i):this.getDocumentsMatchingCollectionQuery(t,e,n,i)}getNextDocuments(t,e,n,i){return this.remoteDocumentCache.getAllFromCollectionGroup(t,e,n,i).next(o=>{const c=i-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(t,e,n.largestBatchId,i-o.size):C.resolve(le());let l=pn,d=o;return c.next(f=>C.forEach(f,(_,I)=>(l<I.largestBatchId&&(l=I.largestBatchId),o.get(_)?C.resolve():this.remoteDocumentCache.getEntry(t,_).next(R=>{d=d.insert(_,R)}))).next(()=>this.populateOverlays(t,f,o)).next(()=>this.computeViews(t,d,f,H())).next(_=>({batchId:l,changes:$h(_)})))})}getDocumentsMatchingDocumentQuery(t,e){return this.getDocument(t,new O(e)).next(n=>{let i=rn();return n.isFoundDocument()&&(i=i.insert(n.key,n)),i})}getDocumentsMatchingCollectionGroupQuery(t,e,n,i){const o=e.collectionGroup;let c=rn();return this.indexManager.getCollectionParents(t,o).next(l=>C.forEach(l,d=>{const f=function(I,R){return new lr(R,null,I.explicitOrderBy.slice(),I.filters.slice(),I.limit,I.limitType,I.startAt,I.endAt)}(e,d.child(o));return this.getDocumentsMatchingCollectionQuery(t,f,n,i).next(_=>{_.forEach((I,R)=>{c=c.insert(I,R)})})}).next(()=>c))}getDocumentsMatchingCollectionQuery(t,e,n,i){let o;return this.documentOverlayCache.getOverlaysForCollection(t,e.path,n.largestBatchId).next(c=>(o=c,this.remoteDocumentCache.getDocumentsMatchingQuery(t,e,n,o,i))).next(c=>{o.forEach((d,f)=>{const _=f.getKey();c.get(_)===null&&(c=c.insert(_,Et.newInvalidDocument(_)))});let l=rn();return c.forEach((d,f)=>{const _=o.get(d);_!==void 0&&hn(_.mutation,f,Ht.empty(),it.now()),dr(e,f)&&(l=l.insert(d,f))}),l})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zd{constructor(){this.Rs=!1,this.Vs=!1,this.fs=100,this.gs=function(){return bu()?8:mh(Su())>0?6:4}()}initialize(t,e){this.ps=t,this.indexManager=e,this.Rs=!0}getDocumentsMatchingQuery(t,e,n,i){const o={result:null};return this.ys(t,e).next(c=>{o.result=c}).next(()=>{if(!o.result)return this.ws(t,e,i,n).next(c=>{o.result=c})}).next(()=>{if(o.result)return;const c=new $d;return this.Ss(t,e,c).next(l=>{if(o.result=l,this.Vs)return this.bs(t,e,c,l.size)})}).next(()=>o.result)}bs(t,e,n,i){return n.documentReadCount<this.fs?(Ie()<=q.DEBUG&&V("QueryEngine","SDK will not create cache indexes for query:",we(e),"since it only creates cache indexes for collection contains","more than or equal to",this.fs,"documents"),C.resolve()):(Ie()<=q.DEBUG&&V("QueryEngine","Query:",we(e),"scans",n.documentReadCount,"local documents and returns",i,"documents as results."),n.documentReadCount>this.gs*i?(Ie()<=q.DEBUG&&V("QueryEngine","The SDK decides to create cache indexes for query:",we(e),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,xt(e))):C.resolve())}ys(t,e){if(xo(e))return C.resolve(null);let n=xt(e);return this.indexManager.getIndexType(t,n).next(i=>i===0?null:(e.limit!==null&&i===1&&(e=_s(e,null,"F"),n=xt(e)),this.indexManager.getDocumentsMatchingTarget(t,n).next(o=>{const c=H(...o);return this.ps.getDocuments(t,c).next(l=>this.indexManager.getMinOffset(t,n).next(d=>{const f=this.Ds(e,l);return this.Cs(e,f,c,d.readTime)?this.ys(t,_s(e,null,"F")):this.vs(t,f,e,d)}))})))}ws(t,e,n,i){return xo(e)||i.isEqual(L.min())?C.resolve(null):this.ps.getDocuments(t,n).next(o=>{const c=this.Ds(e,o);return this.Cs(e,c,n,i)?C.resolve(null):(Ie()<=q.DEBUG&&V("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),we(e)),this.vs(t,c,e,lh(i,pn)).next(l=>l))})}Ds(t,e){let n=new lt($a(t));return e.forEach((i,o)=>{dr(t,o)&&(n=n.add(o))}),n}Cs(t,e,n,i){if(t.limit===null)return!1;if(n.size!==e.size)return!0;const o=t.limitType==="F"?e.last():e.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(i)>0)}Ss(t,e,n){return Ie()<=q.DEBUG&&V("QueryEngine","Using full collection scan to execute query:",we(e)),this.ps.getDocumentsMatchingQuery(t,e,Jt.min(),n)}vs(t,e,n,i){return this.ps.getDocumentsMatchingQuery(t,n,i).next(o=>(e.forEach(c=>{o=o.insert(c.key,c)}),o))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _t="WebChannelConnection";class rf extends ef{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,e,n,i,o){const c=ws();return new Promise((l,d)=>{const f=new wa;f.setWithCredentials(!0),f.listenOnce(Aa.COMPLETE,()=>{try{switch(f.getLastErrorCode()){case Hn.NO_ERROR:const I=f.getResponseJson();V(_t,`XHR for RPC '${t}' ${c} received:`,JSON.stringify(I)),l(I);break;case Hn.TIMEOUT:V(_t,`RPC '${t}' ${c} timed out`),d(new x(P.DEADLINE_EXCEEDED,"Request time out"));break;case Hn.HTTP_ERROR:const R=f.getStatus();if(V(_t,`RPC '${t}' ${c} failed with status:`,R,"response text:",f.getResponseText()),R>0){let S=f.getResponseJson();Array.isArray(S)&&(S=S[0]);const k=S==null?void 0:S.error;if(k&&k.status&&k.message){const M=function(K){const z=K.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(z)>=0?z:P.UNKNOWN}(k.status);d(new x(M,k.message))}else d(new x(P.UNKNOWN,"Server responded with status "+f.getStatus()))}else d(new x(P.UNAVAILABLE,"Connection failed."));break;default:F(9055,{l_:t,streamId:c,h_:f.getLastErrorCode(),P_:f.getLastError()})}}finally{V(_t,`RPC '${t}' ${c} completed.`)}});const _=JSON.stringify(i);V(_t,`RPC '${t}' ${c} sending request:`,i),f.send(e,"POST",_,n,15)})}T_(t,e,n){const i=ws(),o=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],c=Sa(),l=Ca(),d={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},f=this.longPollingOptions.timeoutSeconds;f!==void 0&&(d.longPollingTimeout=Math.round(1e3*f)),this.useFetchStreams&&(d.useFetchStreams=!0),this.jo(d.initMessageHeaders,e,n),d.encodeInitMessageHeaders=!0;const _=o.join("");V(_t,`Creating RPC '${t}' stream ${i}: ${_}`,d);const I=c.createWebChannel(_,d);this.I_(I);let R=!1,S=!1;const k=new nf({Yo:N=>{S?V(_t,`Not sending because RPC '${t}' stream ${i} is closed:`,N):(R||(V(_t,`Opening RPC '${t}' stream ${i} transport.`),I.open(),R=!0),V(_t,`RPC '${t}' stream ${i} sending:`,N),I.send(N))},Zo:()=>I.close()}),M=(N,K,z)=>{N.listen(K,G=>{try{z(G)}catch(Y){setTimeout(()=>{throw Y},0)}})};return M(I,nn.EventType.OPEN,()=>{S||(V(_t,`RPC '${t}' stream ${i} transport opened.`),k.o_())}),M(I,nn.EventType.CLOSE,()=>{S||(S=!0,V(_t,`RPC '${t}' stream ${i} transport closed`),k.a_(),this.E_(I))}),M(I,nn.EventType.ERROR,N=>{S||(S=!0,be(_t,`RPC '${t}' stream ${i} transport errored. Name:`,N.name,"Message:",N.message),k.a_(new x(P.UNAVAILABLE,"The operation could not be completed")))}),M(I,nn.EventType.MESSAGE,N=>{var K;if(!S){const z=N.data[0];Z(!!z,16349);const G=z,Y=(G==null?void 0:G.error)||((K=G[0])==null?void 0:K.error);if(Y){V(_t,`RPC '${t}' stream ${i} received error:`,Y);const at=Y.status;let W=function(p){const T=st[p];if(T!==void 0)return Ya(T)}(at),E=Y.message;W===void 0&&(W=P.INTERNAL,E="Unknown error status: "+at+" with message "+Y.message),S=!0,k.a_(new x(W,E)),I.close()}else V(_t,`RPC '${t}' stream ${i} received:`,z),k.u_(z)}}),M(l,Ra.STAT_EVENT,N=>{N.stat===cs.PROXY?V(_t,`RPC '${t}' stream ${i} detected buffering proxy`):N.stat===cs.NOPROXY&&V(_t,`RPC '${t}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{k.__()},0),k}terminate(){this.c_.forEach(t=>t.close()),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter(e=>e===t)}}function Wr(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jr(r){r=ls(r,wt);const t=ls(r.firestore,Rc);return qf(Hf(t),r._key).then(e=>Zf(t,r,e))}dn._jsonSchemaVersion="firestore/querySnapshot/1.0",dn._jsonSchema={type:ot("string",dn._jsonSchemaVersion),bundleSource:ot("string","QuerySnapshot"),bundleName:ot("string"),bundle:ot("string")};class Jf extends Xf{constructor(t){super(),this.firestore=t}convertBytes(t){return new Nt(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new wt(this.firestore,null,e)}}function Zf(r,t,e){const n=e.docs.get(t._key),i=new Jf(r);return new fe(r,i,t._key,n,new on(e.hasPendingWrites,e.fromCache),t.converter)}(function(t,e=!0){(function(i){Le=i})(Ml),Jn(new fn("firestore",(n,{instanceIdentifier:i,options:o})=>{const c=n.getProvider("app").getImmediate(),l=new Rc(new Jl(n.getProvider("auth-internal")),new eh(c,n.getProvider("app-check-internal")),function(f,_){if(!Object.prototype.hasOwnProperty.apply(f.options,["projectId"]))throw new x(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new yn(f.options.projectId,_)}(c,i),c);return o={useFetchStreams:e,...o},l._setSettings(o),l},"PUBLIC").setMultipleInstances(!0)),Ce(po,_o,t),Ce(po,_o,"esm2020")})();const tg={apiKey:"AIzaSyANSk1PwPkMabX6kRGOYnldoeEC8VvtB5Q",authDomain:"ai-resume-f9b01.firebaseapp.com",projectId:"ai-resume-f9b01",storageBucket:"ai-resume-f9b01.firebasestorage.app",messagingSenderId:"836466410766",appId:"1:836466410766:web:146188f9d00106ea1d835f"},eg=lo().length===0?Ea(tg):lo()[0],Zr=zf(eg),ts="https://ai-resume-git-feature-9d1c2b-gopalakrishnachennu-5461s-projects.vercel.app",bc=document.getElementById("not-connected"),Vc=document.getElementById("connected"),es=document.getElementById("connect-btn"),St=document.getElementById("fill-btn"),ve=document.getElementById("refresh-btn"),ns=document.getElementById("settings-btn");document.getElementById("dashboard-btn");const ng=document.getElementById("user-name"),rg=document.getElementById("user-email"),sg=document.getElementById("user-avatar"),ig=document.getElementById("avatar-letter"),Dc=document.getElementById("stat-filled");document.getElementById("stat-accuracy");const Nc=document.getElementById("stat-apps");let D=null,ge=null;async function og(){var t;console.log("[Popup] Initializing with Firebase sync...");const r=await chrome.storage.local.get(["auth","stats"]);(t=r.auth)!=null&&t.uid?(ge=r.auth.uid,console.log("[Popup] Found userId:",ge),await ti(ge),xc(r.auth,D,r.stats)):(console.log("[Popup] No userId in storage - showing not connected"),ag()),cg()}async function ti(r){var t,e,n,i,o,c,l,d,f,_,I,R,S,k,M,N,K,z,G,Y,at,W,E,g,p,T,y,v;try{console.log("[Popup] Loading data from Firebase for:",r);const m=await Jr(Yr(Zr,"activeSession",r));if(m.exists()){D=m.data(),console.log("[Popup] ✅ Sess loaded:",D.jobCompany);const Mt={identity:{firstName:((t=D.personalInfo)==null?void 0:t.firstName)||"",lastName:((e=D.personalInfo)==null?void 0:e.lastName)||"",fullName:((n=D.personalInfo)==null?void 0:n.fullName)||"",email:((i=D.personalInfo)==null?void 0:i.email)||"",phone:((o=D.personalInfo)==null?void 0:o.phone)||"",location:{address:((c=D.personalInfo)==null?void 0:c.location)||"",city:((l=D.personalInfo)==null?void 0:l.city)||"",state:((d=D.personalInfo)==null?void 0:d.state)||"",country:((f=D.personalInfo)==null?void 0:f.country)||"",zip:""},linkedin:((_=D.personalInfo)==null?void 0:_.linkedin)||"",github:((I=D.personalInfo)==null?void 0:I.github)||"",portfolio:((R=D.personalInfo)==null?void 0:R.portfolio)||"",website:((S=D.personalInfo)==null?void 0:S.otherUrl)||""},authorization:{workAuth:((k=D.extensionSettings)==null?void 0:k.workAuthorization)||"citizen",needSponsor:((M=D.extensionSettings)==null?void 0:M.requireSponsorship)==="true",willingToRelocate:((N=D.extensionSettings)==null?void 0:N.willingToRelocate)==="true",securityClearance:((K=D.extensionSettings)==null?void 0:K.securityClearance)||""},role:{salaryMin:((z=D.extensionSettings)==null?void 0:z.salaryMin)||0,startDate:((G=D.extensionSettings)==null?void 0:G.expectedJoiningDate)||"",noticePeriod:((Y=D.extensionSettings)==null?void 0:Y.noticePeriod)||""},compliance:{gender:((at=D.extensionSettings)==null?void 0:at.gender)||"",ethnicity:((W=D.extensionSettings)==null?void 0:W.ethnicity)||"",veteran:((E=D.extensionSettings)==null?void 0:E.veteranStatus)||"",disability:((g=D.extensionSettings)==null?void 0:g.disabilityStatus)||""},education:{history:D.education||[]},experience:{history:D.experience||[],currentCompany:(T=(p=D.experience)==null?void 0:p[0])!=null&&T.current?D.experience[0].company:"",currentTitle:(v=(y=D.experience)==null?void 0:y[0])!=null&&v.current?D.experience[0].title:""},skills:D.skills||{}};await chrome.storage.local.set({session:D,profile:Mt})}else console.log("[Popup] No active session");let rt=(D==null?void 0:D.extensionSettings)||{},ht=rt.groqApiKeys||rt.groqApiKey,Ct={};if(!ht){const Mt=await Jr(Yr(Zr,"users",r,"settings","extension"));Mt.exists()&&(Ct=Mt.data(),ht=Ct.groqApiKeys||Ct.groqApiKey,console.log("[Popup] Loaded user settings"))}if(!ht){const Mt=await Jr(Yr(Zr,"adminSettings","extension"));if(Mt.exists()){const _e=Mt.data();Ct={...Ct,..._e},ht=Ct.groqApiKeys||Ct.groqApiKey,console.log("[Popup] Loaded admin settings (Global Keys)")}}ht&&ht.includes(`
`)&&(ht=ht.split(`
`)[0].trim()),ht?(await chrome.storage.local.set({settings:{...Ct,groqApiKey:ht,groqModel:rt.groqModel||Ct.groqModel||"llama3-8b-8192"}}),console.log("[Popup] ✅ Groq API Key cached")):console.warn("[Popup] ⚠️ No Groq API Key found in settings")}catch(m){console.error("[Popup] Firebase load failed:",m)}}function xc(r,t,e){var o,c;bc.style.display="none",Vc.style.display="flex";const n=r.displayName||((o=t==null?void 0:t.personalInfo)==null?void 0:o.name)||"User",i=r.email||((c=t==null?void 0:t.personalInfo)==null?void 0:c.email)||"";if(ng.textContent=n,rg.textContent=i,r.photoURL?sg.innerHTML=`<img src="${r.photoURL}" alt="${n}">`:ig.textContent=n[0].toUpperCase(),e&&(Dc.textContent=e.filledToday||0,Nc.textContent=e.totalFilled||0),t!=null&&t.jobTitle){const l=St.querySelector(".btn-subtitle");l&&(l.textContent=`${t.jobTitle} @ ${t.jobCompany}`)}}function ag(){bc.style.display="flex",Vc.style.display="none"}function cg(){var i;es==null||es.addEventListener("click",()=>{chrome.tabs.create({url:ts+"/settings/extension"})}),St==null||St.addEventListener("click",ug),ve==null||ve.addEventListener("click",async()=>{if(ge){const o=ve.textContent;ve.textContent="...",await ti(ge),ve.textContent=o;const c=await chrome.storage.local.get(["auth","stats"]);xc(c.auth,D,c.stats)}else chrome.tabs.create({url:ts+"/settings/extension"})}),ns==null||ns.addEventListener("click",()=>{chrome.tabs.create({url:ts+"/settings/extension"})}),(i=document.getElementById("dashboard-btn"))==null||i.addEventListener("click",()=>{const o=config.webappUrl+"/dashboard";chrome.tabs.create({url:o})});const r=document.getElementById("data-btn"),t=document.getElementById("data-modal"),e=document.getElementById("close-data"),n=document.getElementById("data-content");r&&r.addEventListener("click",()=>{var o,c,l,d,f,_,I,R,S,k,M,N,K,z,G,Y,at,W,E,g;if(t&&(t.style.display="block"),D&&n){const p=y=>!y||y.length===0?'<span class="empty">None</span>':y.map(v=>{const m=v.title||v.degree||v.name||"Unknown",rt=v.company||v.school||v.issuer||"";return`<div class="data-item"><strong>${m}</strong> <span>${rt}</span></div>`}).join(""),T=`
                    ...
                    <div class="data-section">
                        ...
                        <div class="data-row"><span>Disability:</span> <strong>${((g=D.extensionSettings)==null?void 0:g.disabilityStatus)||"-"}</strong></div>
                    </div>
                ...
                `;n.innerHTML=T,n.style.whiteSpace="normal"}else n&&(n.innerHTML='<div class="empty-state-small">⚠️ No Active Session Data.<br>Please go to Dashboard and click ⚡ Flash on a resume.</div>')}),e&&e.addEventListener("click",()=>{t&&(t.style.display="none")})}async function ug(){const r=St.querySelector(".btn-title"),t=St.querySelector(".btn-icon"),e=r.textContent,n=t.textContent;St.classList.add("loading"),r.textContent="Filling...",t.textContent="↻";try{ge&&await ti(ge);const o=await chrome.storage.local.get(["profile","session"]);if(console.log("[Popup] Fill with data:",o),!o.profile&&!o.session){i(),r.textContent="No session - Flash first!",setTimeout(()=>{r.textContent=e},2e3);return}const[c]=await chrome.tabs.query({active:!0,currentWindow:!0});if(!(c!=null&&c.id)){i(),r.textContent="No active tab",setTimeout(()=>{r.textContent=e},2e3);return}chrome.tabs.sendMessage(c.id,{type:"FILL_FORM"},l=>{if(St.classList.remove("loading"),chrome.runtime.lastError){r.textContent="Please Refresh Page",t.textContent="↻",setTimeout(()=>{r.textContent=e,t.textContent=n},3e3);return}l!=null&&l.success?(St.classList.add("success"),r.textContent="Filled "+(l.filled||0)+" Fields!",t.textContent="✓",lg(l.filled||0),setTimeout(()=>{St.classList.remove("success"),r.textContent=e,t.textContent=n},3e3)):(r.textContent=(l==null?void 0:l.error)||"No forms found",t.textContent="⚠",setTimeout(()=>{r.textContent=e,t.textContent=n},2500))})}catch(o){console.error("[Popup] Fill error:",o),i()}function i(){St.classList.remove("loading"),r.textContent=e,t.textContent=n}}async function lg(r){try{const e=(await chrome.storage.local.get(["stats"])).stats||{filledToday:0,totalFilled:0};e.filledToday=(e.filledToday||0)+r,e.totalFilled=(e.totalFilled||0)+r,await chrome.storage.local.set({stats:e}),Dc.textContent=e.filledToday,Nc.textContent=e.totalFilled}catch(t){console.error("[Popup] Update stats failed:",t)}}document.addEventListener("DOMContentLoaded",og);
